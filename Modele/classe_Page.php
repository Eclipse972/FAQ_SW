...
class PageVE extends PageArticle	{
	...
	public function TitreVE($titre, $VE) { // VE et dossierVE ne sont pas forcément identiques.Exemple: tronc de cône et tronc2cone
		...
		<p>On veut r&eacute;aliser : <?=$this->BaliseImage("Piece/{$this->dossier}/VEcote.png","{$VE} cot&eacute;",'style="vertical-align:middle; height:300px"')?></p>
		<?php
	}
	...
	public function PlanDesquisse() {
		...
		<p>choisir un plan d&apos;esquisse (Face, Dessus ou Doite) dans l&apos;arbre de cr&eacute;ation<?=$this->BaliseImage("arbre.png","Arbre de cr&eacute;ation vide",'style="vertical-align:middle"')?></p>
	...
	public function EsquisseCotée($icone_principale, $extrusion = true, $icone_secondaire = '') {
		...
		<p>Il faut dessiner :<?=$this->BaliseImage("Piece/{$this->dossier}/esquisse.png","esquisse cot&eacute;e",'style="vertical-align:middle; height:300px"')?></p>
		<p>Dans la barre d&apos;outils, cliquez sur l&apos;onglet <b>Esquisse</b> (deuxi&egrave;me onglet) :<?=$this->BaliseImage("outilsEsquisse.png","Barre )?d&apos;outils Esquisse")?></p>
		<p>Vous aurez besoin des ic&ocirc;nes:</p>
		<ul>
			<li>
				<?php
				echo $icone_principale,$this->BaliseImage("Piece/{$this->dossier}/icone.png", "ic&ocirc;ne {$icone_principale}",'style="height:30px; vertical-align:middle"');
				if ($icone_secondaire != '')
					echo " et {$icone_secondaire}", $this->BaliseImage("Piece/{$this->dossier}/icone2.png","ic&ocirc;ne {$icone_secondaire}",'style="height:30px; vertical-align:middle"');
				?>
			</li>
			<?=$extrusion ? '' : '<li>ligne de construction' . $this->BaliseImage("ligne2construction.png","ic&ocirc;ne ligne de construction",'style="height:30px; vertical-align:middle"') . "pour cr&eacute;er l&apos;axe de r&eacute;volution.</li>\n\t"?>
			<li>cotation intelligente<?=$this->BaliseImage("cotation.png", "ic&ocirc;ne cotation intelligente",'style="vertical-align:middle"')?> . pour coter votre esquisse.</li>
		</ul>
		<p>Vid&eacute;o de d&eacute;monstration &agrave; venir.</p>
		</div>
	...
	public function MiseEnVolume($extrusion = true, $dépouille =false) {
		...
		<ol>
			<li>Dans la barre d&apos;outils, s&eacute;lectionnez l&apos;alpha <b>Fonctions</b> (premier alpha) :<?=$this->BaliseImage("fonctions.png","Barre d&apos;outils Fonctions.",'style="vertical-align:middle"')?></li>
			<li>Cliquez sur l&apos;ic&ocirc;ne <b><?=$extrusion ? 'Base/Bossage extrud&eacute;' : 'Base bossage avec r&eacute;volution'?></b>
				<?=$this->BaliseImage(($extrusion ? 'extrusion.png' : 'revolution.png'),"ic&ocirc;ne de mise en volume",'style="height:30px; vertical-align:middle"')?>
				<?=$extrusion ? ' premi&egrave;re' : ' deuxi&egrave;me'?> ic&ocirc;ne.
			</li>

			<p class="gauche"><?=$this->BaliseImage(($extrusion ? 'param_extrusion.png' : 'param_revolution.png'),"param&egrave;tres")?></p>
			...
			<?php if (($extrusion) && ($dépouille))
				echo "<li>Cliquez sur l&apos;ic&ocirc;ne d&eacute;pouille ", $this->BaliseImage("depouille.png","icocirc:ne d&eacute;pouille",'style="height:30px; vertical-align:middle"'), "puis entrez l&apos;angle en degr&eacute;s.</li>";
			?>
			<li>Enfin validez en cliquant sur <?=$this->BaliseImage("validation.png","icocirc:ne d&eacute;pouille",'style="height:30px; vertical-align:middle"')?> en haut à gauche.</li>
		</ol>
		<p>Vid&eacute;o de d&eacute;monstration &agrave; venir.</p>
		</div>
