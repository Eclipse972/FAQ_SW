...
?>
	...
	<?=PEUNC\Page::BaliseImage("Piece/onglet_fonctions.png","onglet Fonctions",'width=98%')?>
	...
	<div>
		<p>Sym&eacute;trie</p>
		<?=PEUNC\Page::BaliseImage("Piece/symetrie.png","Sym&eacute;trie",'width=25%')?>
	</div>
	<div>
		<p>R&eacute;p&eacute;tition lin&eacute;aire</p>
		<?=PEUNC\Page::BaliseImage("Piece/repetition_lin.png","R&eacute;p&eacute;tition lin&eacute;aire",'width=25%')?>
	</div>
	<div>
