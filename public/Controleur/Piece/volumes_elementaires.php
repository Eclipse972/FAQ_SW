...
?>
	...
	<ol>
		...
		<li>utiliser une fonction de mise en volume en utilisant la barre d'outils Fonctions (onglet)<?=PEUNC\Page::BaliseImage("Piece/onglet_fonctions.png","Barre d&apos;outils Fonctions", "width=98%")?></li>
	</ol>
