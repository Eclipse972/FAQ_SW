...
>>>>>>> convergencePEUNC
=======
-- Généré le : Sam 01 Mai 2021 à 01:31
>>>>>>> convergencePEUNC
...
(13, 0, 2, 0, 'Retrouver un article', '', 'rechercher', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/trouver_article/page.html'),
...
(31, 4, 1, 0, 'Les zooms', '', 'zoom', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/zoom/page.html'),
(32, 4, 2, 0, 'Ouvrir un fichier', 'Vue/images/icone_ouvrir.png', 'ouvrir_fichier', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/ouvrir_fichier/page.html'),
(33, 4, 3, 0, 'M&eacute;canique graphique', '', 'meca', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/meca_graphique/page.html'),
(34, 4, 4, 0, 'Mon casier nm&eacute;rique', 'Vue/images/casier.png', 'Casier_numerique', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/casier_numerique/page.html'),
(35, 4, 1, 2, 'ajuster le zoom', '', 'ajuster', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/ajuster_zoom/page.html'),
(37, 4, 1, 3, 'zoom au mieux', 'Vue/images/zoomOmieux.png', 'au_mieux', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/zoom_au_mieux/page.html'),
(38, 4, 1, 1, 'zoom fen&ecirc;tre', 'Vue/images/zoomFenetre.png', 'Fenetre', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/zoom_fenetre/page.html'),
(39, 1, 1, 1, 'outils d&apos;esquisse', '', 'outilDesquisse', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/outilsDesquisse/page.html'),
(40, 1, 1, 2, 'plan d&apos;esquisse', '', 'planDesuisse', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/planDesquisse/page.html'),
(41, 2, 2, 1, 'les vues standards', '', 'vue_standard', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/vues_std/page.html'),
(42, 2, 2, 2, 'vue en coupe', '', 'coupe', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/vue_coupe/page.html'),
(43, 2, 2, 3, 'perspective personnalis&eacute;e', '', '3Dperso', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/perspective_perso/page.html'),
(44, 1, 2, 1, 'Extrusion', 'Vue/images/extrusion.png', 'extrusion', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/extrusion/page.html'),
(45, 1, 2, 2, 'R&eacute;volution', 'Vue/images/revolution.png', 'revolution', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/revolution/page.html'),
(46, 1, 2, 3, 'Balayage', 'Vue/images/balayage.png', 'balayage', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/balayage/page.html'),
(47, 1, 2, 4, 'Symétrie', 'Vue/images/symetrie.png', 'symetrie', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/symetrie/page.html'),
(48, 1, 2, 5, 'R&eacute;p&eacute;tition lin&eacute;aire', 'Vue/images/repetition_lineaire.png', 'repetition_lineaire', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/rep_lineaire/page.html'),
(49, 1, 2, 6, 'R&eacute;p&eacute;tition circulaire', 'Vue/images/repetition_circulaire.png', 'repetition_circulaire', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/rep_circulaire/page.html'),
(50, 1, 2, 7, 'Assistance pour le per&ccedil;age', 'Vue/images/percage.png', 'percage', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/percage/page.html'),
(51, 1, 2, 8, 'Cong&eacute et chanfrein', 'Vue/images/conge.png', 'conge_chanfrein', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/chanfrein/page.html'),
(52, 1, 1, 3, 'cotation intelligente', 'Vue/images/cotation.png', 'cotation_intelligente', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/cotation_intelligente/page.html'),
(53, 1, 1, 4, 'contrainte d&apos;esquisse', '', 'contrainteDesquisse', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/contrainteDesquisse/page.html'),
(54, 1, 1, 5, 'ligne de construction', 'Vue/images/ligne2construction.png', 'ligne2construction', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/ligne2construction/page.html'),
(55, 1, 1, 6, 'code couleur', '', 'code_couleur', 1, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/code_couleur/page.html'),
...
(64, 1, 5, 4, 'sph&egrave;re', 'Vue/images/sphere.png', 'sphere', 2, 'La Foire Aux Questions sur SolidWorks de ChristopHe', 'Vue/images/logo.png', '<p class="font-effect-outline">Foire Aux Questions SolidWorks de ChristopHe</p>', 'Articles/sphere/page.html'),
...
(52, 1, 1, 3, 'cotation intelligente', 'cotation.png', 'cotation_intelligente', 1, 'Piece/cotation_intelligente.php'),
