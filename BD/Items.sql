...
-- Généré le : Lun 05 Avril 2021 à 01:38
...
INSERT INTO `Items` (`onglet`, `item`, `sous_item`, `texte`, `image`, `article_ID`) VALUES
(3, 0, 0, 'Assemblage', 'Vue/images/assemblage.png', 4),
(2, 0, 0, 'Mise en plan', 'Vue/images/MEP.png', 3),
(4, 0, 0, 'Autre', 'Vue/images/autre.png', 5),
(0, 0, 0, 'Accueil', 'Vue/images/accueil.png', 1),
(1, 0, 0, 'Pi&egrave;ce', 'Vue/images/piece.png', 2),
(0, 1, 0, 'Qui suis-je?', '', 6),
(0, 2, 0, 'Retrouver un article', '', 7),
(1, 1, 0, 'Esquisse 2D', 'Vue/images/esquisse.png', 8),
(1, 2, 0, 'Les fonctions', '', 9),
(1, 3, 0, 'Manipuler la pi&egrave;ce', '', 10),
(1, 4, 0, 'Arbre de cr&eacute;ation', '', 11),
(2, 1, 0, 'Les fonds de plan', '', 12),
(2, 2, 0, 'Ins&eacute;rer des vues', 'Vue/images/3vues.png', 13),
(2, 3, 0, 'Ajouter la cotation', '', 14),
(2, 4, 0, 'Mise en page', 'Vue/images/deplacement_vue.png', 15),
(2, 5, 0, 'Remplir le Cartouche', '', 16),
(2, 6, 0, 'Export en PDF', 'Vue/images/Pdf.png', 17),
...
(3, 4, 0, 'Cr&eacute;er un &eacute;clat&eacute;', 'Vue/images/icone_eclater_rassembler.png', 23),
(3, 5, 0, 'Cr&eacute;er un &eacute;corch&eacute;', '', 24),
(4, 1, 0, 'Les zooms', '', 25),
(4, 2, 0, 'Ouvrir un fichier', 'Vue/images/icone_ouvrir.png', 26),
...
(1, 2, 1, 'Extrusion', 'Vue/images/extrusion.png', 38),
(1, 2, 2, 'R&eacute;volution', 'Vue/images/revolution.png', 39),
(1, 2, 3, 'Balayage', '', 40),
(1, 2, 4, 'Symétrie', '', 41),
...
(1, 2, 6, 'R&eacute;p&eacute;tition circulaire', 'Vue/images/repetition_circulaire.png', 43),
(1, 1, 3, 'cotation intelligente', 'Vue/images/cotation.png', 46),
(1, 1, 4, 'contrainte d&apos;esquisse', '', 47),
(1, 1, 5, 'ligne de construction', 'Vue/images/ligne2construction.png', 48),
...
(1, 5, 0, 'Volumes &eacute;l&eacute;mentaires', '', 55),
