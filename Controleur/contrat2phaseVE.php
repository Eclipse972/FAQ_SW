...
<?php
function Titre($dossierVE, $titre, $VE) { // VE et dossierVE ne sont pas forcément identiques.Exemple: tronc de cône et tronc2cone
	?>
...
function PlanDesquisse($dossierVE) {
	?>
	<div id="Phase">
...
function EsquisseCotée($dossierVE, $icone_principale, $extrusion = true, $icone_secondaire = '') {
	?>
	<div id="Phase">
...
function MiseEnVolume($dossierVE, $extrusion = true, $dépouille =false) {
	?>
