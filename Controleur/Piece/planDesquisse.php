...
?>
	...
	<?=$this->BaliseImage("Piece/axe.png","exemple",'width="300"')?>
	...
	<?=$this->BaliseImage("Piece/face.png","plan de Face",'width="600"')?>
	...
	<?=$this->BaliseImage("Piece/plan.png","plan ajout&eacute;",' width="600"')?>
	<h2>Utiliser une surface plane de la pi&egrave;ce</h2>
	<p>Ici on utilise le fond du lamage comme plan d&apos;esquisse</p>
	<?=$this->BaliseImage("Piece/surface.png","plan de Face",'width="300"')?>
