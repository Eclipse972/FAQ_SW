...
?>
	...
	<?=\PEUNC\classes\Page::BaliseImage("Piece/axe.png","exemple",'width="300"')?>
	...
	<?=\PEUNC\classes\Page::BaliseImage("Piece/face.png","plan de Face",'width="600"')?>
	...
	<?=\PEUNC\classes\Page::BaliseImage("Piece/plan.png","plan ajout&eacute;",' width="600"')?>
