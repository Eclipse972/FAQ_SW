...
?>
	...
	<?=$this->BaliseImage("Piece/onglet_fonctions.png","onglet Fonctions",'width=98%')?>
	...
	<div>
		<p>Sym&eacute;trie</p>
		<?=$this->BaliseImage("Piece/symetrie.png","Sym&eacute;trie",'width=25%')?>
	</div>
	<div>
		<p>R&eacute;p&eacute;tition lin&eacute;aire</p>
		<?=$this->BaliseImage("Piece/repetition_lin.png","R&eacute;p&eacute;tition lin&eacute;aire",'width=25%')?>
	</div>
	<div>
		<p>R&eacute;p&eacute;tition circulaire</p>
		<?=$this->BaliseImage("Piece/repetition_circ.png","R&eacute;p&eacute;tition circulaire",'width=25%')?>
	</div>
<?php
