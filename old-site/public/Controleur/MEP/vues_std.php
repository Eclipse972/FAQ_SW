...
?>
	...
	<?=PEUNC\Page::BaliseImage("MEP/9vues.png","9 vues",'width=800px')?>
	...
	<?=PEUNC\Page::BaliseImage("MEP/vue_principale.png","vue principale + palette de vues",'width=800px')?>
	...
	<?=PEUNC\Page::BaliseImage("MEP/autres_vues.png","les autres vues",' width=400px')?>
	...
	<?=PEUNC\Page::BaliseImage("MEP/menu_contextuel.png","extrait du menu contextuel pour suppression",'width=300px')?>
